import{_ as n}from"./plugin-vue_export-helper-c27b6911.js";import{o as s,c as a,f as t}from"./app-d0fb0332.js";const e={},p=t(`<h1 id="drf28-metadata" tabindex="-1"><a class="header-anchor" href="#drf28-metadata" aria-hidden="true">#</a> DRF28-Metadata</h1><p>OPTIONS允许客户端确定与资源相关的选项和/或需求，而无需暗示资源操作或启动资源检索。</p><h2 id="一、metadata" tabindex="-1"><a class="header-anchor" href="#一、metadata" aria-hidden="true">#</a> 一、Metadata</h2><p>简介<br> REST框架包含一个可配置的机制，用于确定API如何响应OPTIONS可选请求。允许你返回API模式或者其他资源信息<br> 目前还没有任何广泛采用的约定来返回HTTP OPTIONS 请求的响应样式，因此我们提供了一种特殊的样式，返回一些有用的信息。</p><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment"># 默认返回的response信息</span>
