import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as e,o as p,c as o,a as n,b as s,d as i,f as l}from"./app-cfbf85c1.js";const c={},u=l(`<h2 id="前言" tabindex="-1"><a class="header-anchor" href="#前言" aria-hidden="true">#</a> 前言</h2><ul><li>前面几篇文章主要介绍了allure的特性，这篇文章我们就来讲下allure的标记用法</li><li>有时候我们写pytest的时候，会用到 @pytest.mark 但并不会显示在allure报告上</li><li>而allure也提供了三种类型的标记装饰器，它们是可以显示在allure报告上的</li></ul><p></p><h2 id="allure的标记装饰器" tabindex="-1"><a class="header-anchor" href="#allure的标记装饰器" aria-hidden="true">#</a> allure的标记装饰器</h2><ul><li>BDD样式的标记装饰器</li><li>优先级（严重程度）标记装饰器</li><li>自定义标记装饰器</li></ul><p></p><h2 id="bdd标记装饰器" tabindex="-1"><a class="header-anchor" href="#bdd标记装饰器" aria-hidden="true">#</a> BDD标记装饰器</h2><p>提供了三个装饰器</p><ul><li>**@allure.epic：**敏捷里面的概念，定义史诗，往下是 feature</li><li>**@allure.feature：**功能点的描述，理解成模块往下是 story</li><li>**@allure.story：**故事，往下是 title</li></ul><p></p><h2 id="栗子一-story-feature" tabindex="-1"><a class="header-anchor" href="#栗子一-story-feature" aria-hidden="true">#</a> 栗子一（story+feature）</h2><h4 id="测试代码" tabindex="-1"><a class="header-anchor" href="#测试代码" aria-hidden="true">#</a> 测试代码</h4><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
