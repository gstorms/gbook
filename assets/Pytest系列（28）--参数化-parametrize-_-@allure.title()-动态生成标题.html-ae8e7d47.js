import{_ as p}from"./plugin-vue_export-helper-c27b6911.js";import{r as e,o,c as i,a as n,b as s,d as t,f as u}from"./app-207e7d61.js";const c={},l=n("h2",{id:"前言",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#前言","aria-hidden":"true"},"#"),s(" 前言")],-1),r={href:"https://www.cnblogs.com/poloyy/p/12675457.html",target:"_blank",rel:"noopener noreferrer"},d=n("li",null,[s("默认 allure 报告上的测试用例标题不设置"),n("strong",null,"默认"),s("就是用例名称，这样可读性不高")],-1),k=n("li",null,[s("当"),n("strong",null,"结合"),s(" @pytest.mark.parametrize 参数化完成数据驱动时，如果标题写死，这样可读性也不高")],-1),v=n("li",null,"所以我们希望标题可以动态的生成，来看看如何做吧",-1),m=u(`<p></p><h2 id="参数化无标题的栗子" tabindex="-1"><a class="header-anchor" href="#参数化无标题的栗子" aria-hidden="true">#</a> 参数化无标题的栗子</h2><h4 id="测试代码" tabindex="-1"><a class="header-anchor" href="#测试代码" aria-hidden="true">#</a> 测试代码</h4><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">#!/usr/bin/env python</span>
