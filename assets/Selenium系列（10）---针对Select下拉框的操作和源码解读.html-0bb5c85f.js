import{_ as t}from"./plugin-vue_export-helper-c27b6911.js";import{r as e,o as p,c as l,a as n,b as s,d as o,f as c}from"./app-731a6e06.js";const i={},u=c(`<h2 id="首先-将下面html代码保存到一个文件中" tabindex="-1"><a class="header-anchor" href="#首先-将下面html代码保存到一个文件中" aria-hidden="true">#</a> 首先，将下面html代码保存到一个文件中</h2><p>后续的代码小案例都是访问此html的<!--DOCTYPE html--></p><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>html</span> <span class="token attr-name">lang</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>en<span class="token punctuation">&quot;</span></span><span class="token punctuation">&gt;</span></span>
