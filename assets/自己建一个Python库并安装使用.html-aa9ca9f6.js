import{_ as e}from"./plugin-vue_export-helper-c27b6911.js";import{o as i,c as n,f as s}from"./app-731a6e06.js";const d={},a=s(`<h1 id="自己建一个python库并安装使用" tabindex="-1"><a class="header-anchor" href="#自己建一个python库并安装使用" aria-hidden="true">#</a> 自己建一个Python库并安装使用</h1><p>在一个空白目录中新建：<code>setup.py</code>文件，模块目录<code>wutils</code>（这个可以任意取名），目录中存放自己的模块文件和<code>__init__.py</code><br> 结构如下：</p><div class="language-powershell line-numbers-mode" data-ext="powershell"><pre class="language-powershell"><code>D:<span class="token operator">/</span>projects/
