...
动态条件查询
filters = {User.age >=15, User.name!=''} 可以在filters中添加或减少条件
User.query.filter(*filters).all()
```

> 参考：[https://blog.csdn.net/xiao_bao_an/article/details/84667705](https://blog.csdn.net/xiao_bao_an/article/details/84667705)
