...
- [How to install Playwright](./intro-js.md#installing-playwright)
- [What's Installed](./intro-js.md#whats-installed)
- [How to run the example test](./intro-js.md#running-the-example-test)
- [How to open the HTML test report](./intro-js.md#html-test-reports)
...
See our doc on [Running Tests](./running-tests-js.md) to learn more about running tests in headed mode, running multiple tests, running specific tests etc.
