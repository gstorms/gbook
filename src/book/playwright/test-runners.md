---
id: test-runners
title: "Pytest Plugin Reference Python"
---

Playwright provides a [Pytest](https://docs.pytest.org/en/stable/) plugin to write end-to-end tests. To get started with it, refer to the [getting started guide](./intro-python.md).
...
See [Running Tests](./running-tests-python.md) for general information on `pytest` options.
